...
public:
    ...
    virtual void RenderSceneCB()
    {
        ...
        pl[3].Color = Vector3f(0.8f, 1.0f, 0.20f);
        pl[3].Position = Vector3f(sinf(m_scale + 16.3f) * 10, 1.0f, cosf(m_scale + 16.3f) * 10);
        pl[3].Attenuation.Linear = 0.1f;

        pl[4].DiffuseIntensity = 0.5f;
        pl[4].Color = Vector3f(0.20f, 1.0f, 0.70f);
        pl[4].Position = Vector3f(sinf(m_scale + 9.4f) * 10, 1.0f, cosf(m_scale + 9.4f) * 10);
        pl[4].Attenuation.Linear = 0.1f;
        

        m_pEffect->SetPointLights(5, pl);
